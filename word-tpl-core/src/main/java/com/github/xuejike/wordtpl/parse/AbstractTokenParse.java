 ...
 */
@Slf4j
public abstract class AbstractTokenParse implements TokenParse {
    protected char[][] startToken;
    protected char[][] endToken;
    protected TplToken[] tokens;


    public AbstractTokenParse(TplToken[] tokens) {
        this.tokens = tokens;
        initToken();
    }
    ...
    @Override
    public void parseFormatTpl(StringBuilder txt, TokenCallback tokenCallback){
